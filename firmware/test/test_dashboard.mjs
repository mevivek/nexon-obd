...
import { checkHardware } from './hardware.mjs';
...
// ---------------------------------------------------------------- hardware
//
// Lifted into hardware.mjs: it grew a variant loop and an XIAO pad map, and
// this file is long enough already. The checks and the reasoning live there.
checkHardware({ ok, eq, readSrc, here, join });
